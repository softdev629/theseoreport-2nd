            ...
            <table class="table table-striped b-t b-light">
              <thead>
                <tr>
                  ...
                  <th>Stopped Project
                    <a
                      href="projectstopped.php?orderby=DESC&page=<?php echo $page; ?>&usertype=<?php echo $projecttype; ?>&searchkeyword=<?php echo $searchkeyword; ?>&orderfield=projectName&mode=show"><span
                        style="font-size:19px;">&nbsp <i class="fa fa-sort-alpha-desc text-inverse"
                          title="Descending Order"></i></span></a>
                    <a
                      href="projectstopped.php?orderby=ASC&page=<?php echo $page; ?>&usertype=<?php echo $projecttype; ?>&searchkeyword=<?php echo $searchkeyword; ?>&orderfield=projectName&mode=show"><span
