            ...
            <table class="table table-striped b-t b-light">
                    ...
                    <a
                      href="client.php?orderby=DESC&page=<?php echo ""; ?>&usertype=<?php echo ""; ?>&searchkeyword=<?php echo $searchkeyword; ?>&orderfield=email&mode=show"><span
                        style="font-size:19px;">&nbsp &nbsp <i class="fa fa-sort-alpha-desc text-inverse"
                          title="Descending Order"></i></span></a>
                    <a
                      href="client.php?orderby=ASC&page=<?php echo ""; ?>&usertype=<?php echo ""; ?>&searchkeyword=<?php echo $searchkeyword; ?>&orderfield=email&mode=show"><span
                        style="font-size:19px;">&nbsp <i class="fa fa-sort-alpha-asc text-success"
                          title="Ascending Order"></i></span></a>
                  </th>
                  <th>Phone</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <form id="forma<?PHP echo $i; ?>" name="forma<?PHP echo $i; ?>" action="client.php?mode=edit"
                      method="post">
                  ...
                  <td>
                    <a href="client.php?action=delete&uid=<?PHP echo $user_data['id']; ?>"
